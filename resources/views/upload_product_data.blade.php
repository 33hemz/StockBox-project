...
{{-- import product csv --}}
@section('content')
<h1 class="border-bottom pb-2">Import Product Data <span class="smaller-text">via CSV</span></h1>
<style>
    .smaller-text {
      font-size: 0.6em;
    }
...
<br>
 ...
 <div class="alert alert-warning" role="alert">
    You <strong>MUST</strong> upload Product Data before Consumer Data to proceed.
</div>
