    ...
    <div class="card shadow-lg" style="background-color: aliceblue">
        ...
        <div style="padding: 50px;">
            <form action="/processlogin" method="post" class="w-full max-w-sm">
                ...
                <br><br>
                <div class="flex items-center border-b border-teal-500 py-2">
                    <input class="@error('password') is-invalid @enderror appearance-none bg-transparent border-none w-full text-gray-700 mr-3 py-1 px-2 leading-tight focus:outline-none" type="text" placeholder="Password" name="password" id="password" aria-label="Password">
                    @error('password')
                    <div class="invalid-feedback">
                        {{ $message }}
                    </div>
