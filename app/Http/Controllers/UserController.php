...
class UserController extends Controller
{
    ...
    public function personasManage($option) 
    {
        ...
        } elseif (request()->filled('cities')) {
            $personas = $personasData->groupBy('city')->map->count()->sortDesc()->first();
        } elseif (request()->filled('dependents')) {
            $personas = $personasData->groupBy('number_of_dependents')->first();
        } elseif (request()->filled('dietary_requirements')) {
            $personas = $personasData->groupBy('dietary_requirements')->first(); 
