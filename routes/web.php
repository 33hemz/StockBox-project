...
Route::middleware('auth')->group(function() {
    ...
    Route::middleware('user_type:USER')->group(function() {
        ...
        Route::get('/my_personas_page', [UserController::class, 'personasManage'])->name('my_personas_page');
        Route::get('/my_personas_page/{option}', [UserController::class, 'personasManage'])->name('my_personas_page');
    });
